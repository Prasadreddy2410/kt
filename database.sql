...
select * from tickets;
drop  table tickets;
insert into tickets(ticketnumber,movieid,seatno)values("2","3","11");
use kt;
...
select count(ticketnumber) from tickets;
create table ss(abhi int);
select * from tickets order by ticketnumber desc limit 1;